({
    doinit_helper01: function(component, event, helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if(state === "SUCCESS") {
                ...
                let bidstatus = localStorage.getItem("genericBidStatus");

                if(bidstatus == null || bidstatus == 'false') component.set("v.genericBidStatus", false);
                else component.set("v.genericBidStatus", true);
                ...
                if(rval.upcomingAuction) {
                    ...
                    helper.formatTimeHelper(component, event, helper, "upcoming");
                }
                ...
                if(rval.ongoingAuction) {
                    ...
                    helper.formatTimeHelper(component, event, helper, "ongoing");
                    helper.formatTimeHelper(component, event, helper, "slab");
                    helper.updateVendorPosition_helper(component, event, helper);
                }
                if(rval.finishedAuction) {
                    helper.updatePosition_helper(component, event, helper);
                }
            }
            if(state === "ERROR") {
    ...
    formatTimeHelper: function(component, event, helper, type) {
       // console.log("formatTimeHelper is running");
    ...
    formatTime: function (component, event, helper, type) {
      //  console.log("formatTime is running");
        let rtime = 0;
       ...
       // console.log("formatTime rtime : " + rtime);
        ...
        if(type === "slab") {
            ...
            if(ntime <= 0) {
                localStorage.setItem("genericBidStatus", false);
                component.set("v.genericBidStatus", false);
    ...
    acceptCurrentBid_helper: function (component, event, helper) {
        ...
        action.setCallback(this, function (response) {
            ...
            if(status === "SUCCESS") {
                ...
                localStorage.setItem("genericBidStatus", true);
                component.set("v.genericBidStatus", true);
            }
            if(status === "ERROR") {
    ...
    updateVendorPosition_helper : function(component, event, helper) {
        let timeoutId =  window.setInterval(
            $A.getCallback(function() {
                helper.updateVendorPosition(component, event, helper);
            }), 10000
        );
    ...
    updateVendorPosition : function(component, event, helper) {
        console.log("updateVendorPosition is running");
